...
void main()
{
    ...
    payload.hitValue = 
     PBR(hitPosition, hitNormal, normalize(hitPosition-camera.position.xyz), normalize(lightPosition-hitPosition), hitColor, object.roughness, object.metallic, object.ambient, payload.hitValue);
